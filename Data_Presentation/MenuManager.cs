public class MenuManager
{
    ...
    //Currently used to test current version of Delete_Item.
    //Because of the filtering/sorting, Delete_Item must be refactored so that it will delete by MenuItem.ID.
    //Add_item in turn must add a unique ID when creating/adding an item.
    public static void DefaultPrintMenu(List<MenuItem> menuItems) => PrintMenu(menuItems);
}
